...
public class GildedShieldItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    private static ShieldEntityModel modelShield;

    public static void loadShieldModel() {
        GildedShieldItemRenderer.modelShield = new ShieldEntityModel(MinecraftClient.getInstance().getEntityModelLoader().getModelPart(EntityModelLayers.SHIELD));
    }
